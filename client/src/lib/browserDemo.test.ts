...
describe("database-free browser demo links", () => {
  it("encodes ciphertext-only demo metadata into a URL fragment", () => {
    ...
    const url = createBrowserDemoUrl({ v: 1, id: "unique-link", title: "Safe demo", ciphertext: "cipher", iv: "iv", authTag: "tag", burnAfterReading: true, expiresAt: 1234, fragmentKey: "browser-key" });
    ...
    expect(browserDemoPayloadFromLocation()).toMatchObject({ id: "unique-link", title: "Safe demo", ciphertext: "cipher", burnAfterReading: true });
